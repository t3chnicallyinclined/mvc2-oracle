...
> (`ubuntu@15.204.141.58`, under `/opt/nobd-oracle/`). See [`../deploy/README.md`](../deploy/README.md)
> for the runbook and `ssh ubuntu@15.204.141.58 /opt/nobd-oracle/status.sh` for a health snapshot.
